...
### Ciencias Naturales Experimentales y Tecnología (Didacteca)

#### Reacciones químicas: conservación de la materia en la formación de nuevas sustancias (CNEYT IV)

- Planes de estudio: BT/CONALEP/DGB/SABES
- Cargo: Asesor pedagógico
- Temas: Química general, química inorgánica, fisicoquímica, química nuclear.

#### Aplicación de la energía en la vida diaria (CNEYT V)

- Planes de estudio: BT
- Cargo: Asesor pedagógico
- Temas: Dinámica, electromagnetismo, física moderna, óptica, termodinámica, fisicoquímica, geología.

### Matemáticas (Didacteca)

#### Pensamiento matemático I

- Planes de estudio: BT/CONALEP/DGB/SLP
- Cargo: Asesor pedagógico
- Temas: Probabilidad y Estadística.

#### Pensamiento matemático I (Y)

- Planes de estudio: Yucatán
- Cargo: Asesor pedagógico
- Temas: Aritmética, álgebra, geometría analítica, optimización matemática.

#### Pensamiento matemático II

- Planes de estudio: BT/CONALEP/DGB/SLP
- Cargo: Asesor pedagógico
- Temas: Aritmética, álgebra, geometría sintética, geometría analítica, optimización matemática.

#### Pensamiento matemático III

- Planes de estudio: BT/CONALEP/DGB
- Cargo: Asesor pedagógico
- Temas: Cálculo diferencial, Cálculo integral.

#### Temas Selectos de Matemáticas I (DGB)

- Planes de estudio: DGB
- Cargo: Asesor pedagógico
- Temas: Trigonometría, geometría **no** euclidiana, álgebra lineal, geometría analítica, geometría fractal.

#### Temas Selectos de Matemáticas II

- Planes de estudio: BT/CONALEP
- Cargo: Asesor pedagógico, Corrector técnico
- Temas: Geometría analítica, cinemática, álgebra, dinámica, trigonometría.

#### Temas Selectos de Matemáticas II (DGB)

- Planes de estudio: DGB
- Cargo: Asesor pedagógico
- Temas: Teoría del caos, cálculo integral, ecuaciones diferenciales.
...
#### Pensamiento matemático I (K)

- Planes de estudio: BT/CONALEP/DGB/SLP
- Cargo: Corrector técnico
- Temas: Probabilidad y Estadística.

#### Pensamiento matemático II (K)

- Planes de estudio: BT/CONALEP/DGB/SLP
- Cargo: Corrector técnico
- Temas: Aritmética, álgebra, geometría sintética, geometría analítica, optimización matemática.

#### Pensamiento matemático III (K)
